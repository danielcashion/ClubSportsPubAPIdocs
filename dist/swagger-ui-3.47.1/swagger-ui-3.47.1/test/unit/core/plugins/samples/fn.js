...
describe("createXMLExample", function () {
  ...
  describe("simple types with xml property", function () {
    ...
    it("returns tag <test:tagname xmlns:sample=\"https://www.theclubsportsorganization.com/schema/sample\">string</test:tagname> when passing type string and xml:{\"namespace\": \"https://www.theclubsportsorganization.com/schema/sample\", \"prefix\": \"sample\"}", function () {
      let definition = {
        type: "string",
        xml: {
          namespace: "https://www.theclubsportsorganization.com/schema/sample",
          prefix: "sample",
          name: "name"
        }
      }

      expect(sut(definition)).toEqual("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<sample:name xmlns:sample=\"https://www.theclubsportsorganization.com/schema/sample\">string</sample:name>")
    })

    it("returns tag <test:tagname >string</test:tagname> when passing type string and xml:{\"namespace\": \"https://www.theclubsportsorganization.com/schema/sample\"}", function () {
      let definition = {
        type: "string",
        xml: {
          namespace: "https://www.theclubsportsorganization.com/schema/sample",
      ...
      expect(sut(definition)).toEqual("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<name xmlns=\"https://www.theclubsportsorganization.com/schema/sample\">string</name>")
    })
